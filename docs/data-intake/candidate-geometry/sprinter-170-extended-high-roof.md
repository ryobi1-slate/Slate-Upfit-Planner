...
| --- | ---: | --- | --- |
| `usable_wall_height` | 74.75 | `single_source_candidate` | SRC-005:74.75; SRC-008:72 inside roof; SRC-004:79/79.1 interior |
...
| `wheel_well_depth` | 9 | `largest_credible_obstruction` | SRC-005:8.5 for 2500/3500XD and 16 for 3500/4500; SRC-008:9; normalized value limited to 2500/3500XD supplier group |
| `driver_side_usable_space` | 170.5 | `single_source_candidate` | SRC-005:172.625 total cargo space; SRC-008:170.5 shelving space; Upfit shelving datum selected |
| `passenger_side_usable_space` | unresolved | `unsupported_or_unclear_datum` | SRC-005:121 door-opening-to-rear; SRC-008:124.5 label/125.5 segment sum |
| `partition_intrusion` | unresolved | `unsupported_or_unclear_datum` | SRC-005:7.5 zone; SRC-008:9 physical depth; datums are not interchangeable |
| `door_opening_width` | 51 | `lowest_credible_supported_value` | SRC-005:51.625; SRC-008:51.5; SRC-004:51 |
| `pre_wheel_well_zone` | 37.4375 | `single_source_candidate` | SRC-005:37.4375; SRC-008:42; Westcan zone datum selected |
| `post_wheel_well_zone` | 47.0625 | `single_source_candidate` | SRC-005:47.0625; SRC-008:47.5; Westcan zone datum selected |
| `total_available_cargo_space` | 172.625 | `single_source_candidate` | SRC-005:172.625 total cargo space; SRC-008:170.5 driver shelving space; Westcan total-space datum selected |
...
`GD-001; GD-002; GD-003; GD-004; GD-005; GD-007`
