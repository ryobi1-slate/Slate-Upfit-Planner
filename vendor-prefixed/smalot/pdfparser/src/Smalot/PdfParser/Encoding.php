...
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Encoding\EncodingLocator;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Encoding\PostScriptGlyphs;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Exception\EncodingNotFoundException;
/**
 * Class Encoding
 */
class Encoding extends PDFObject
{
    ...
    protected function getEncodingClass() : string
    {
        ...
        $className = '\\Slate\\UpfitPlanner\\Vendor\\Smalot\\PdfParser\\Encoding\\' . $baseEncoding;
