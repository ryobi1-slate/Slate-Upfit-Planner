...
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementArray;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementBoolean;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementDate;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementHexa;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementName;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementNull;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementNumeric;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementString;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementStruct;
use Slate\UpfitPlanner\Vendor\Smalot\PdfParser\Element\ElementXRef;
/**
 * Class Element
 */
class Element
        ...
        do {
            ...
            if (!$only_values) {
                if (!\preg_match('/\\G\\s*(?P<name>\\/[A-Z#0-9\\._]+)(?P<value>.*)/si', $content, $match, 0, $position)) {
                    ...
                    $name = \preg_replace_callback('/#([0-9a-f]{2})/i', function ($m) {
